...
public class Test {
	private static final String[] PROGRAM_NAMES = {"Internet Explorer", "Microsoft Word",
													"Microsoft Excel", "Notepad++",
													"Eclipse", "Windows Media Player",
													"Google Chrome", "Mozilla Firefox",
													"Netbeans", "Skype",
													"Paint", "TeXstudio",
													"StarUML", "Telegram",
													"MySQL Workbench",	"MarkdownPad",
													"IntelliJ IDEA", "PyCharm",
													"Atom", "Wireshark"};
	private static final String[] PROGRAM_VERSIONS = {"1.0","1.1","1.2","1.3","1.4","1.5",
	...
	private static final String[] MODEL = {"Core i3", "Core i5", "Corei7","Pentium", "Celeron", "FX-8350","FX-6350","FX-4300","A4-4020"};
	//But: remplir la base de donn�es avec des infos permettant de montrer des graphiques repr�sentatifs et l'utilisation des filtres
	...
	public static void main(String[] args){
		...
		/*private String hostname; --> pc*(variable de boucle)
		private String ipAddress; --> g�n�r�e une fois al�atoirement au d�but
		private String macAddress; --> g�n�r�e une fois al�atoirement au d�but
		private String os; --> tableau
		private CPUInfo cpu;
			private String constructor; --> tableau
			private String model; --> tableau
			private double frequency; --> tableau
			private int numbCore; --> tableau
		private HDDInfo hdd;
			private double totalSize; --> tableau
			private double freeSize; --> g�n�rer al�atoirement en fonction de total,puis faire �voluer
		private long ramSize; --> tableau
		private LinkedList<Program> programs;
		 	String name; --> tableau
			String version; --> tableau
		*/
		for(int i = 0; i < 20; i++){
			...
			//G�n�rer programmes-> nombre al�atoire de programmes install�s, choix al�atoire des prorgammes et des versions
			...
			for(int j = 0; j < nbPrograms; j++){
				programs.add(new Program(PROGRAM_NAMES[r.nextInt(PROGRAM_NAMES.length)], PROGRAM_VERSIONS[r.nextInt(PROGRAM_VERSIONS.length)]));
			}
			parc.add(new PCInfo(hostname, ip, mac, os,
					new CPUInfo(constructor, model, freq, nbCores),
